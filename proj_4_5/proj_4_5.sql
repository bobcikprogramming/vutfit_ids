...
insert into klient(rodneCislo, jmeno, prijmeni, email, adresa) values('0102250742', 'Filip', 'Buráò', 'filda@gmail.com', Null);
...
create or replace procedure prumernyVekKlientu as
  ...
  begin
    ...
    dbms_output.put_line('Prùmìrný vìk klientù je ' || ROUND((celkemLet/klientuCelkem),0) ||'.');
    close klienti;
  exception
